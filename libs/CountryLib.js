...
TF:{
 ...
 alt:["French Southern and Antarctic Lands"],
 phone:null,
 currency:"EUR",
...
VA:{
 name:"Holy See",
 alt:["Vatican City","Vatican City State"],
 phone:"+379",
 currency:"EUR",
...
KP:{
 name:"North Korea",
 alt:["Democratic People's Republic of Korea"],
 phone:"+850",
 currency:"KPW",
 capital:"Pyongyang",
 continent:"Asia",
...
function format(code){
  ...
  let text = getFlag(code) + " <b>" + c.name + "</b> (" + code + ")\n\n"
  ...
  if(c.continent){
    text += "🌍 Continent: " + c.continent + "\n"
  }

  if(c.timezone){
    text += "🕐 Timezone: " + c.timezone.join(", ") + "\n"
  }
